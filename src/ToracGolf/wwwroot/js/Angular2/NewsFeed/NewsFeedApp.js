System.register(['angular2/core', './NewsFeedService', '../Common/CustomFormatterService', './NewsFeedItem', './NewsFeedComment', 'angular2/common', 'rxjs/add/operator/map'], function(exports_1, context_1) {
    "use strict";
