System.register(['@angular/core', './NewsFeedService', '../Common/CustomFormatterService', './NewsFeedItem', './NewsFeedComment', '@angular/common', 'rxjs/add/operator/map'], function(exports_1, context_1) {
    "use strict";
